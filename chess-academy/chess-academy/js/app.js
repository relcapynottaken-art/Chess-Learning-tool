...
(function (global) {
  ...
  function bootstrap() {
    ...
    // Ensure a fully-completed administrator account exists. Credentials are
    // intentionally non-default (distinct username + strong password).
    try { Auth.seedCompletedAccount('headcoach_y0721g', '_jhY%FHYsaO2q@gTPWiPkHej', 'Administrator'); } catch (e) { }
