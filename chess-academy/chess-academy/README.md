...
- A dashboard with your "Continue" button, and a profile page with stats and a
  progress reset.
- A pre-built **administrator** account that has everything completed — log in with
  `headcoach_y0721g` / `_jhY%FHYsaO2q@gTPWiPkHej`. (Defined in `js/app.js`; change
  them there if you like.)
